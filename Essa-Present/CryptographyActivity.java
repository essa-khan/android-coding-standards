...
public class CryptographyActivity extends AppCompatActivity {
    ...
    */
    ...
    /*
        encryptGCM() and encryptECB() would violate Android (Java Applied) Recs. 22 MET50-J, MET51-J with the below shape:
    ...
    */
    ...
    /*
    Android (Java Applied) Rule 19. Input Validation and Data Sanitization - Perform any string
    modifications before validation. Only perform string modifications before validation has occurred
    since an attacker may be able to bypass validation through string manipulation using unique characters.

    Replaces all HTML tags in user input with an empty tag to avoid malicious tags (i.e. <script>).
    */
    public static String filterString(String str) {
        String input = Normalizer.normalize(str, Normalizer.Form.NFKC);
